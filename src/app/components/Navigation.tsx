    ...
    <>
      ...
      >
        <span className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between w-full">
          <Link to="/" className="flex items-center gap-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand">
            <motion.img
          ...
          <ul className="hidden md:flex items-center gap-8 list-none p-0 m-0">
            {navLinks.map(({ to, label }) => (
              <li key={to}>
                <Link
                  to={to}
                  className={`text-sm tracking-wide transition-colors duration-200 relative py-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand ${
